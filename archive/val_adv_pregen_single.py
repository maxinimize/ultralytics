...
class DetectionValidator(BaseValidator):
    ...
    def __call__(self, trainer=None, model=None):
        ...
        # Override dataset loading if attack_name is specified
        if getattr(self, "attack_name", None) or getattr(self.args, "attack_name", None):
            self._override_dataset_load_image(self.dataloader.dataset)
    ...
    def _override_dataset_load_image(self, dataset) -> None:
        ...
        for d in datasets:
            ...
            # Reset any cached images to ensure they are re-loaded using custom_load_image
